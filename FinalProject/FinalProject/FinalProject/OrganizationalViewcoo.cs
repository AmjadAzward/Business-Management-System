...
{
    public partial class OrganizationalViewcoo : Form
    {
        string connectionString = "Server=Ilma_A;Database=finalPJS;Trusted_Connection=True;";
        private string currentUsername;
        string loggedinuser = "";
        public OrganizationalViewcoo(string userName)
        {
            InitializeComponent();
        ...
        private void OrganizationalViewcoo_Load(object sender, EventArgs e)
        {
