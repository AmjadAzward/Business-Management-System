...
{
    public partial class AssistantAccountant : Form
    {
        ...
        public AssistantAccountant(string userName)
        {
            InitializeComponent();
        ...
        {
            EmpAttendance mainForm = new EmpAttendance(currentUsername);
            mainForm.Show();
            this.Hide();
        }
        ...
        {
            StaffSalaryAssistant mainForm = new StaffSalaryAssistant(currentUsername);
            mainForm.Show();
            this.Hide();
        }
        ...
        private void AssistantAccountant_Load(object sender, EventArgs e)
        {
        ...
        private void Feetbackdgv_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
