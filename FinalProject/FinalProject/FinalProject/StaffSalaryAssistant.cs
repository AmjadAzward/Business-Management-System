...
{
    public partial class StaffSalaryAssistant : Form
    {
        string connectionString = "Server=Ilma_A;Database=finalPJS;Trusted_Connection=True;";
        private string currentUsername;

        string loggedinuser = "";
        public StaffSalaryAssistant(string userName)
        {
            InitializeComponent();
        ...
        private void StaffSalaryAssistant_Load(object sender, EventArgs e)
        {
