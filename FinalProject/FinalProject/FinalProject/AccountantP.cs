    ...
    public partial class AccountantP : Form
    {
        ...
        private void LoadAccountantData()
        {
            ...
            try
            {
                ...
                {
                    string query = "SELECT earlyJobTitles, bankDetails FROM Accountant WHERE employeeId = @employeeId";
            ...
            {
                MessageBox.Show($"Error loading accountant data: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void AccountantP_Load(object sender, EventArgs e)
        {
            LoadAccountantData();
        }
        ...
        private void guna2Button1_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string checkQuery = "SELECT COUNT(1) FROM Accountant WHERE employeeId = @employeeId";
                    using (SqlCommand checkCommand = new SqlCommand(checkQuery, connection))
                    {
                        ...
                        if (count > 0)
                        {
                            string updateQuery = "UPDATE Accountant " +
                            ...
                            using (SqlCommand updateCommand = new SqlCommand(updateQuery, connection))
                            {
                                ...
                                MessageBox.Show("Accountant record updated successfully!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                        }
                        else
                        {
                            string insertQuery = "INSERT INTO Accountant (employeeId, earlyJobTitles, bankDetails) " +
                            ...
                            using (SqlCommand insertCommand = new SqlCommand(insertQuery, connection))
                            {
                                ...
                                MessageBox.Show("Accountant record added successfully!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                        }
                    }
                }
